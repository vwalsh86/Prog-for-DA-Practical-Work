...
The aim of this repository is to successfully investigate the numpy.random package and clearly produce and explain my findings from different aspects.
...
This repository will contain a combination of:
<ul>
  <li>Text</li>
  <li>Code</li>
  <li>Images</li>
...
In order to run Jupyter Notebook on a machine, you need the programming language Python to be pre-installed.
...
The Jupyter Notebook is started from within the Command Prompt or Terminal of a computer. The user enters the command 'jupyter notebook' and presses 'Enter' on their keyboard. After a few moments, the Jupyter Notebook will launch within a browser window. </br>
The machine which you are using will determine the type of command window you use,, some examples include: 
<ul>
